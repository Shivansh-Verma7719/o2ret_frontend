  ...
  return (
    <div className="container1">
      ...
      <div className='about-text'>
        <h1 className='titles'>Discover our Solutions</h1>
        ...
        <h1  className='titles'>Location Analytics</h1>
      ...
      <div className='about-text py-10 md:py-0'>
        <h1 className='titles'>Shelf-Space Acquisition and Curation</h1>
        ...
        <div className="about-section">
        <div className='about-text2 py-10 md:py-0'>
        <h1 className='titles'>Distributor Aggregation</h1>
